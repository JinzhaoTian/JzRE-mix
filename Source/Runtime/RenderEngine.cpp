...
// Static API_FUNCTION methods form the P/Invoke boundary (glue generated by JzRE.Build);
// each delegates to the singleton instance's Impl method.
...
const char* RenderEngine::GetLastErrorImpl() const
{
...
bool RenderEngine::Create(void* nativeWindow, int x, int y, int w, int h)
{
    return Get().CreateImpl(nativeWindow, x, y, w, h);
}
...
void RenderEngine::Resize(int x, int y, int w, int h)
{
    Get().ResizeImpl(x, y, w, h);
}
...
float RenderEngine::GetSuggestedDistance()
{
    return Get()._distance;
}

const char* RenderEngine::GetLastError()
{
    return Get().GetLastErrorImpl();
}

// ── Instance implementation ─────────────────────────────────────────────────

bool RenderEngine::CreateImpl(void* nativeWindow, int x, int y, int width, int height)
{
...
bool RenderEngine::LoadFileImpl(const char* path)
{
...
void RenderEngine::ResizeImpl(int x, int y, int width, int height)
{
